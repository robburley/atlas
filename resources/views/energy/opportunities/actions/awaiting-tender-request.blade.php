<div class="row">
    <div class="col-sm-6">
        <h4>Upload the energy tender</h4>

        <a href="javascript:" onclick="jQuery('#upload-tender').modal('show', {backdrop: 'fade'});"
...
@section('scripts')
    ...
    @component('interface.components.modal')
        @slot('modalId', 'upload-tender')
        @slot('modelBorderClass', 'border-top-success')
        @slot('modalTitle', 'Upload Energy Tender')
        @slot('modalBody')
            ...
            <div class="modal-body">
                <div class="form-group">
                    <div class="col-sm-12">
                        ...
                        {!! Form::hidden('customer_file_type_id', 10) !!}
