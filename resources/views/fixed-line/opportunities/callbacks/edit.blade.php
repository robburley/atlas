        ...
        <div class="col-sm-12">
            <div class="panel panel-default border-top-success">
                <div class="panel-body">
                    <div class="row">
                        <div class="col-sm-6">
                            {!! Form::model($callback, ['action' => ['FixedLineOpportunity\CallbackController@update', $callback->opportunity->customer, $callback->opportunity, $callback], 'role' => 'form', 'class' => 'form-horizontal']) !!}
