...
@section('content')
    ...
    <div class="row">
        {{--Mobile--}}
        @if(auth()->user()->hasPermission('create_mobile') || auth()->user()->hasPermission('show_all_leads_mobile'))
            <div class="col-sm-6">
        ...
        {{--Mobile Appointments--}}
        @if(auth()->user()->hasPermission('create_appointments_mobile') || auth()->user()->hasPermission('show_all_appointment_leads_mobile'))
        ...
        {{--Fixed Line--}}
        @if(auth()->user()->hasPermission('create_fixed_line') || auth()->user()->hasPermission('show_all_leads_fixed_line'))
            <div class="col-sm-6">
        ...
        @if(auth()->user()->hasPermission('create_appointments_fixed_line') || auth()->user()->hasPermission('show_all_appointment_leads_fixed_line'))
            {{--Fixed Line Appointments--}}
            <div class="col-sm-6">
