                            ...
                            <table class="table">
                                ...
                                @forelse ($opportunities as $opportunity)
                                    <tr>
                                        ...
                                        <td class="v-mid">
                                            {!! Form::open(['action' => ['MobileOpportunity\Fulfilment\BondPaymentController@create', $opportunity->customer_id, $opportunity], 'method' => 'get']) !!}

                                            <button class="btn btn-xs btn-info btn-icon pull-right">
                                                <i class="fa fa-fw fa-folder-open"></i>
                                                <span>Add Bond Payment Reference</span>
                                            </button>
                                            {!! Form::close() !!}
                                        </td>
                                    </tr>
