                                ...
                                @forelse ($opportunities as $opportunity)
                                    <tr>
                                        ...
                                        <td class="v-mid">
                                            ...
                                            {!! Form::open(['action' => ['MobileOpportunity\Fulfilment\PacCodeController@create', $opportunity->customer_id, $opportunity], 'method' => 'get']) !!}


                                            <button class="btn btn-xs btn-info btn-icon">
                                                <i class="fa fa-fw fa-folder-open"></i>
                                                <span>Obtain PAC Code</span>
                                            </button>
                                            {!! Form::close() !!}
                                        </td>
                                    </tr>
